    ...
    <div className='w-full'>
      <div className='w-full'>
        <div className='flex items-start gap-x-2 '>
          ...
          <p className='font-semibold text-neutral-700 dark:text-white mb-2'>Description</p>
        </div>
        {isEditing ? (
          <form ref={formRef} className='space-y-2' action={onUpdateDesc}>
            <FormTextarea
              id='description'
              className='w-full mt-2 dark:bg-bgDarkMode dark:text-textDarkMode'
          ...
          <div
            ...
            role='button'
            className={cn(
              'min-h-[78px] bg-neutral-200 text-sm font-medium py-3 px-3.5 rounded-md dark:bg-bgDarkMode dark:text-textDarkMode',
      ...
      <div className='flex items-start gap-x-2 mt-6'>
        <CalendarCheck2 className='h-5 w-5 mt-0.5 text-neutral-700 dark:text-white' />
        <p className='font-semibold text-neutral-700 dark:text-white mb-2'>Due day</p>
      </div>
      <Popover>
