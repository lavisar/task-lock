  ...
  return (
    <div className='flex justify-center flex-col items-center'>
      ...
      <div className={cn(
        ...
        From high rises to the home office, the way your team works is unique - accomplish it all with TaskLock
      </div>
      <Button className='mt-6' size="lg" asChild>
        <Link href="/sign-up">
          Get TaskLock for free</Link>
      </Button>
    </div>
  );
};
